...
# os.environ['PYSPARK_SUBMIT_ARGS'] = '--jars /root/Desktop/spark-core_2.11-1.5.2.logging.jar  --packages org.apache.spark:spark-streaming-kafka_2.11:1.5.2 pyspark-shell'
...
# kafkaStream = KafkaUtils.createStream(ssc, "localhost:9092", "spark-streaming", {"streaming.transactions.details":1})
kafkaStream = KafkaUtils.createStream(ssc, "zookeeper:2181", "spark-streaming", {"streaming.transactions.details":1})
